//
//  MusicTheoryLibrary.h
//  ToneBarrier3D
//
//  Created by Xcode Developer on 3/25/20.
//  Copyright © 2020 James Bush. All rights reserved.
//

#ifndef MusicTheoryLibrary_h
#define MusicTheoryLibrary_h
...
struct Music {
  ...
  */
    static NSDictionary<NSString *, NSNumber *> * notes =
    @{@"C": 0,
      @"D": @(2),
      @"E": @(4),
      @"F": @(5),
  ...
  */
  static char Degrees = ["I", "II", "III", "IV", "V", "VI", "VII"]
